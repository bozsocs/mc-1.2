...
bedrockSoundOptions = ['stone1.ogg','stone2.ogg','stone3.ogg','stone4.ogg']
...
stepOnbedrockSoundOptions = ['stone5.ogg','stone6.ogg','stone7.ogg','stone8.ogg','stone9.ogg','stone10.ogg']
...
bow = ['bow.obj','bow.png',0.5,0.5,grassSoundOptions,"bow",0.2,-20,10,30,0.85,-0.65]
...
bedrock = ['bedrock.obj','bedrock.png',0.625,0.4,bedrockSoundOptions,"bedrock",0.25,-20,10,30,0.85,-0.65]
    ...
    if abs(player.x-pX)>1.5 or abs(player.z-pZ)>1.5:
        ...
        for box in boxes:
            if box.x == round(player.x) and box.z == round(player.z) and box.y == round(player.y)-1:
                ...
                elif box.block_type == "bedrock":
                    stepSound = random.choice(stepOnbedrockSoundOptions)
    ...
    for box in boxes:
        if box.hovered:
            ...
            if key == 'left mouse down':
                ...
                if box.block_type == "bedrock":
                    breakingSound = random.choice(bedrockSoundOptions)
